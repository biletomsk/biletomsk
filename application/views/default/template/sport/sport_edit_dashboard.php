        ...
        <div id="tabs">
            ...
            <div id="tabs-1">
                ...
                <table width="570" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td width="146">
                            <img src="<?php echo base_site_url();?>sport/logo/<?php echo $detail->sp_img;?>" />Логотип (100х100)
                        </td>
                        <td width="235">
            ...
            <div id="tabs-4">
                <table width="570" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td>
                            <input type="checkbox" <?php echo($detail->sp_1 == '1') ? 'checked="checked" ' : ' '; ?> name="sp_1"/>
                        </td>
                        <td>
                            <p>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="checkbox" <?php echo($detail->sp_5 == '1') ? 'checked="checked" ' : ''; ?> name="sp_5"/>
                        </td>
                        <td>
                            <p>
              		 ...
              		 <tr>
                        ...
                        <td>
                            <p>
                                <a href="#" id="dialog_link" title="banners" class="ui-state-default ui-corner-all"><span class="ui-icon ui-icon-newwin"></span>редактировать</a>
                            </p>
                        </td>
                    </tr>
                    <tr>
